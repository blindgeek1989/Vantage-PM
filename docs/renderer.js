...
function scheduleLocalSave(){
  ...
  _localSaveTimer=setTimeout(()=>AppStorage.saveData({tasks,members,projects,milestones,activityLog,auditResults,customStatuses,templates,projectNotes,filterPresets,persona:settings.persona,appMode:settings.appMode}),800);
}
...
async function saveSetting(key,value){settings[key]=value;await AppStorage.saveSettings({[key]:value});}
